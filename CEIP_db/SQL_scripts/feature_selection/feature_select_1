-- WARNING: THIS CODE DOES NOT WORK. IT CREATES NEW ROWS AND TAKES FOREVER TO RUN
...
-- INNER JOIN operations mandates that these are identical - only rows where the ixJobSummary value matches in both tables will be included
